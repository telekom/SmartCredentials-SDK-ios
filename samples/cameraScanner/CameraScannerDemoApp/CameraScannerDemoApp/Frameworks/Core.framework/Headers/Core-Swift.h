...
SWIFT_CLASS("_TtC4Core13IActionModule")
@interface IActionModule : NSObject <NSCoding>
...
SWIFT_CLASS("_TtC4Core16ItemToJsonAction")
@interface ItemToJsonAction : IActionModule
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
@end
