...
public class MalaysiaMyTenteraIDFrontCardResult: IDCardResult {
    
    public var armyNumber: String?
    ...
    init(with result: MBMalaysiaMyTenteraFrontRecognizerResult) {
        super.init()
        
        self.armyNumber = result.armyNumber
        self.dateOfBirth = result.birthDate.date
        self.city = result.city
        self.address = result.fullAddress
