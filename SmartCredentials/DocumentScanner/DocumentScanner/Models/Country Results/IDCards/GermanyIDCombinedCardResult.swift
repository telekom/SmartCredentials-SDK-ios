...
public class GermanyIDCombinedCardResult: IDCardResult {
    ...
    public var canNumber: String?
    public var mrzVerified: Bool?
    
    init(with result: MBGermanyCombinedRecognizerResult) {
        super.init()
        ...
        self.eyeColor = result.eyeColor
        self.canNumber = result.canNumber
