...
extension DefaultStorageController: StorageAPI {
    func getItemSummary(for itemFilter: ItemFilter) -> SmartCredentialsAPIResult<ItemEnvelope> {
        ...
        let storageController = StorageControllerProvider.storageController(for: itemFilter.contentType, userId: configuration.userId)
    ...
    func put(_ item: ItemEnvelope, with itemContext: ItemContext) -> SmartCredentialsAPIEmptyResult {
        ...
        let storageController = StorageControllerProvider.storageController(for: itemContext.contentType, userId: configuration.userId)
    ...
    func put(_ genericPassword: String, with id: String) -> SmartCredentialsAPIEmptyResult {
        ...
        let storageController = StorageControllerProvider.storageController(for: .sensitive, userId: configuration.userId)
